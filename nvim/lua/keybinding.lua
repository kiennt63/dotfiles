...
if vim.g.vscode then
    keymap("n", "<leader>e", "<cmd> lua vim.fn.VSCodeNotify('workbench.view.explorer')<cr>", opts)
    keymap("n", "<leader>ff", "<cmd> lua vim.fn.VSCodeNotify('workbench.action.quickOpen')<cr>", opts)
    keymap("n", "<leader>fg", "<cmd> lua vim.fn.VSCodeNotify('workbench.action.findInFiles')<cr>", opts)
    ...
    -- keymap("n", "<leader>fp", "<cmd>Telescope media_files<cr>", opts)
